...
BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('Spacewars', 'Grenade+1.mp3'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join('Spacewars', 'Gun+Silencer.mp3'))
...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Spacewars', 'spaceship_yellow.png'))
yellow_spaceship = pygame.transform.rotate(pygame.transform.scale(
    YELLOW_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)

RED_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Spacewars', 'spaceship_red.png'))

red_spaceship = pygame.transform.rotate(pygame.transform.scale(
    RED_SPACESHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)),270 )

SPACE = pygame.transform.scale(pygame.image.load(os.path.join('Spacewars', 'space.png')), (WIDTH, HEIGHT))
